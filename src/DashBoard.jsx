...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    setStats({
      totalPatients: stored.length,
      doctors: 5,
      todayAppointments: stored.length,
      completed: Math.floor(stored.length / 2),
    });
  }, []);
  ...
  return (
    <div className="space-y-6 mt-10 mx-4">
      <input
        ...
        value={query}
        className="mb-4 mt-16 p-2 px-6 border rounded-sm"
      />

      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card title="Total Patients" value={stats.totalPatients} color="blue" />
        <Card title="Doctors" value={stats.doctors} color="green" />
        <Card
          title="Today's Appointments"
          value={stats.todayAppointments}
          color="purple"
        />
        <Card title="Completed" value={stats.completed} color="orange" />
      </div>
